...
#数据增强
aug_image = (x_image+1) * 127.5
data_aug_1 = tf.image.random_flip_left_right(aug_image)
...
pooling2 = pool_wrapper(conv2_3, 'pool2')
...
pooling3 = pool_wrapper(conv3_3, 'pool3')
